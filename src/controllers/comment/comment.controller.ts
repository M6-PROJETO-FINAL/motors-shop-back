...
import commentByAdvertisementIdService from "../../services/comment/commentByAdvertisementId.service copy";
...
const commentByAdvertisementIdController = async (req: Request, res: Response) => {
  const { id } = req.params
